...
public class EditLid extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		}else if(rol.equalsIgnoreCase("Geblokkeerd")){
			ENUMRol = GebruikerRol.Geblokkeerd;
		}
	...
	public void validate(){
		//Gebruiker aanmaken zodat bij een fail je de ingevulde gegevens ziet
		gebruiker = new Gebruiker(id, voornaam, tussenvoegsel, achternaam, gebruikersnaam, email1, 
				wachtwoord1, adres, postcode, woonplaats, geboorteDate, telefoonnummer, ENUMRol);
